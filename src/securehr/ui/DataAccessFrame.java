...
public class DataAccessFrame extends JFrame {
    ...
    public DataAccessFrame(AppUser user) {
        super("ZES-SecureHR - Dữ liệu được cấp");
    ...
    private JPanel buildSidebar() {
        ...
        sidebar.add(UiTheme.createSidebarButton("Dữ liệu được cấp", true));
        sidebar.add(Box.createVerticalStrut(8));
