...
public class StatisticsFrame extends JFrame {
    ...
    public StatisticsFrame(AppUser user) {
        super("ZES-SecureHR - Thống kê");
    ...
    private JPanel buildSidebar() {
        ...
        JButton overviewBtn = UiTheme.createSidebarButton("Tổng quan", false);
        overviewBtn.addActionListener(e -> {
            new UserFrame(currentUser);
            dispose();
        });
        ...
        sidebar.add(UiTheme.createSidebarButton("Đăng xuất", true));
    ...
    private JPanel buildMainContent() {
        ...
        dataCard.add(UiTheme.createSectionTitle("Báo cáo thống kê"), BorderLayout.NORTH);
        ...
        content.add(dataCard, BorderLayout.CENTER);
    ...
    private void loadByRole() {
        try {
            DefaultTableModel model = employeeService.getPublicEmployeeData();
