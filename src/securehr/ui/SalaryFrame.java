...
public class SalaryFrame extends JFrame {
    ...
    public SalaryFrame(AppUser user) {
        super("ZES-SecureHR - Quản lý lương & thưởng");
    ...
    private JPanel buildSidebar() {
        ...
        sidebar.add(UiTheme.createSidebarButton("Lương & Thưởng", true));
        sidebar.add(Box.createVerticalStrut(8));
    ...
    private JPanel buildMainContent() {
        ...
        cardHeader.add(UiTheme.createSectionTitle("Bảng lương & thưởng"), BorderLayout.WEST);
        cardHeader.add(UiTheme.createHint("Dữ liệu lương được tách bảo mật từ DB2"),
                BorderLayout.SOUTH);
    ...
    private JPanel buildActionPanel() {
        ...
        JButton addBtn = UiTheme.createPrimaryButton("Thêm dữ liệu");
        JButton editBtn = UiTheme.createPrimaryButton("Chỉnh sửa");
        JButton importBtn = UiTheme.createPrimaryButton("Nhập dữ liệu");
        ...
        editBtn.addActionListener(e -> handleEditSalary());

        importBtn.addActionListener(e -> {
            ImportSalaryDialog dialog = new ImportSalaryDialog(this);
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                refreshTable();
            }
    ...
    private void refreshTable() {
        try {
            DefaultTableModel model = employeeService.getSalaryDataForAccountant();
